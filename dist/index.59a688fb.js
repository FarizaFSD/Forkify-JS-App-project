...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;F=M?x.bind(x):function(){return x.apply(x,arguments)};var P={}.propertyIsEnumerable,T=Object.getOwnPropertyDescriptor;o=T&&!P.call({1:2},1)?function(e){var t=T(this,e);return!!t&&t.enumerable}:P;var I={};I=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var q={},H={},N={},A=Function.prototype,D=A.call,C=M&&A.bind.bind(D,D),R={},W=(N=M?C:function(e){return function(){return D.apply(e,arguments)}})({}.toString),z=N("".slice);R=function(e){return z(W(e),8,-1)};var U=Object,G=N("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
eM=function(e){return ex(B(e))};var eP=N({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
eF=Object.hasOwn||function(e,t){return eP(eM(e),t)};var eT={},eI=0,eq=Math.random(),eH=N(1..toString);eT=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eH(++eI+eq,36)};var eN=O.Symbol,eA=eE("wks"),eD=ea?eN.for||eN:eN&&eN.withoutSetter||eT,eC=TypeError,eR=(eF(eA,e="toPrimitive")||(eA[e]=es&&eF(eN,e)?eN[e]:eD("Symbol."+e)),eA[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
V=function(e,t){if(!K(e)||en(e))return e;var r,n=eg(e,eR);if(n){if(void 0===t&&(t="default"),r=F(n,e,t),!K(r)||en(r))return r;throw eC("Can't convert object to primitive value")}return void 0===t&&(t="number"),ew(e,t)},// `ToPropertyKey` abstract operation
...
var eB=Object.getOwnPropertyDescriptor;i=j?eB:function(e,t){if(e=q(e),t=Q(t),eW)try{return eB(e,t)}catch(e){}if(eF(e,t))return I(!F(o,e,t),e[t])};var eJ={},eY={};// V8 ~ Chrome 36-
...
var tH=function(e){return function(t,r,n){var i,o=q(t),a=tT(o),s=t$(n,a);// Array#includes uses SameValueZero equality algorithm
...
indexOf:tH(!1)}.indexOf,tA=N([].push);tO=function(e,t){var r,n=q(e),i=0,o=[];for(r in n)!eF(ta,r)&&eF(n,r)&&tA(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)eF(n,r=t[i++])&&(~tN(o,r)||tA(o,r));return o};var tD=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");f=Object.getOwnPropertyNames||function(e){return tO(e,tD)},p=Object.getOwnPropertySymbols;var tC=N([].concat);// all object keys, includes non-enumerable and symbols
tS=ei("Reflect","ownKeys")||function(e){var t=f(eQ(e));return p?tC(t,p(e)):t},tE=function(e,t,r){for(var n=tS(t),o=0;o<n.length;o++){var a=n[o];eF(e,a)||r&&eF(r,a)||c(e,a,i(t,a))}};var tR={},tW=/#|\.prototype\./,tz=function(e,t){var r=tG[tU(e)];return r===tJ||r!==tB&&(X(t)?L(t):!!t)},tU=tz.normalize=function(e){return String(e).replace(tW,".").toLowerCase()},tG=tz.data={},tB=tz.NATIVE="N",tJ=tz.POLYFILL="P";tR=tz,/*
...
if(a=t[n],o=e.dontCallGetSet?(s=i(r,n))&&s.value:r[n],!tR(u?n:c+(l?".":"#")+n,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;tE(a,o)}(e.sham||o&&o.sham)&&eJ(a,"sham",!0),e4(r,n,a,e)}};var tY={},tQ={},tV=Function.prototype,tK=tV.apply,tX=tV.call;// eslint-disable-next-line es/no-reflect -- safe
...
tZ=function(e,t){return em(e),void 0===t?e:M?t1(e,t):function(){return e.apply(t,arguments)}};var t2={};t2=ei("document","documentElement");var t3={};t3=N([].slice);var t4={},t7=TypeError;t4=function(e,t){if(e<t)throw t7("Not enough arguments");return e};var t9={};// eslint-disable-next-line redos/no-vulnerable -- safe
t9=/(?:ipad|iphone|ipod).*applewebkit/i.test(eu);var t5={};t5="process"===R(O.process);var t8=O.setImmediate,t6=O.clearImmediate,re=O.process,rt=O.Dispatch,rr=O.Function,rn=O.MessageChannel,ri=O.String,ro=0,ra={},rs="onreadystatechange";L(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t8&&t6||(t8=function(e){t4(arguments.length,1);var t=X(e)?e:rr(e),r=t3(arguments,1);return ra[++ro]=function(){tQ(t,void 0,r)},v(ro),ro},t6=function(e){delete ra[e]},t5?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t9?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!L(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rf=(tY={set:t8,clear:t6}).clear;// `clearImmediate` method
...
rh=function(e,t){var r=t?2:1;return rm?function(n,i/* , ...arguments */){var o=t4(arguments.length,1)>r,a=X(n)?n:rg(n),s=o?t3(arguments,r):[],c=o?function(){tQ(a,this,s)}:a;return t?e(c,i):e(c)}:e};// https://github.com/oven-sh/bun/issues/1633
...
(this.arg=t),v}},e}({});try{regeneratorRuntime=rb}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=rb:Function("r","regeneratorRuntime = r")(rb)}const r_="https://forkify-api.herokuapp.com/api/v2/recipes/",rw="df57e421-1279-4bf6-8ccd-551ec13573fc",rk=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},rE={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},rS=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rO=async function(e){try{let t=await rk(`${r_}${e}?key=${rw}`);rE.recipe=rS(t),rE.bookmarks.some(t=>t.id===e)?rE.recipe.bookmarked=!0:rE.recipe.bookmarked=!1,console.log(rE.recipe)}catch(e){throw(// Temp error handling
console.error(`${e} 💥💥💥💥`),e)}},r$=async function(e){try{rE.search.query=e;let t=await rk(`${r_}?search=${e}&key=${rw}`);console.log(t),rE.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),rE.search.page=1}catch(e){throw console.error(`${e} 💥💥💥💥`),e}},rj=function(e=rE.search.page){rE.search.page=e;let t=(e-1)*rE.search.resultsPerPage,r=e*rE.search.resultsPerPage;// 0
return rE.search.results.slice(t,r)},rL=function(e){rE.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rE.recipe.servings;// newQt = oldQt * newServings / oldServings // 2 * 8 / 4 = 4
}),rE.recipe.servings=e},rF=function(){localStorage.setItem("bookmarks",JSON.stringify(rE.bookmarks))},rM=function(e){// Add bookmark
rE.bookmarks.push(e),e.id===rE.recipe.id&&(rE.recipe.bookmarked=!0),rF()},rx=function(e){// Delete bookmark
...
return 1!=t&&r.push(t),r;// Return the prime factors
  ...
  `}}var rH=new rq;class rN{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rA=new rN,rD=new class extends rI{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
      <li class="preview">
...
1===e&&t>1?`
      ...
      `:"")}}var rz=new rW;class rU extends rI{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rD.render(e,!1)).join("")}}var rG=new rU;class rB extends rI{_parentElement=document.querySelector(".upload");_message="Recipe was successfully uploaded :)";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rJ=new rB;const rY=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rH.renderSpinner(),rR.update(rj()),rG.update(rE.bookmarks),// 2) Loading recipe
await rO(e),rH.render(rE.recipe)}catch(e){rH.renderError(),console.error(e)}},rQ=async function(){try{rR.renderSpinner();// 1) Get search query
let e=rA.getQuery();if(!e)return;// 2) Load search results
await r$(e),rR.render(rj()),rz.render(rE.search)}catch(e){console.log(e)}},rV=async function(e){try{rJ.renderSpinner(),// Upload the new recipe data
await rP(e),console.log(rE.recipe),rH.render(rE.recipe),rJ.renderMessage(),rG.render(rE.bookmarks),// Change ID in URL
window.history.pushState(null,"",`#${rE.recipe.id}`),// Close form window
setTimeout(function(){rJ.toggleWindow()},2500)}catch(e){console.error("\uD83D\uDCA5",e),rJ.renderError(e.message)}};rG.addHandlerRender(function(){rG.render(rE.bookmarks)}),rH.addHandlerRender(rY),rH.addHandlerUpdateServings(function(e){// Update the recipe servings (in state)
rL(e),rH.update(rE.recipe)}),rH.addHandlerAddBookmark(function(){rE.recipe.bookmarked?rx(rE.recipe.id):rM(rE.recipe),rH.update(rE.recipe),rG.render(rE.bookmarks)}),rA.addHandlerSearch(rQ),rz.addHandlerClick(function(e){rR.render(rj(e)),rz.render(rE.search)}),rJ.addHandlerUpload(rV);//# sourceMappingURL=index.59a688fb.js.map

//# sourceMappingURL=index.59a688fb.js.map
